...
public class Computer implements Serializable{
    ...
    public int makePrediction(String p){
        ...
        Pattern p1 = new Pattern(added1);
        Pattern p2 = new Pattern(added2);
        Pattern p3 = new Pattern(added3);

        //checks to see if it has even occurred
        boolean isInHashMap1 = hm.containsKey(p1);
        boolean isInHashMap2 = hm.containsKey(p2);
        boolean isInHashMap3 = hm.containsKey(p3);
        ...
        if ( (!isInHashMap1) && (!isInHashMap2) && (!isInHashMap3)){
